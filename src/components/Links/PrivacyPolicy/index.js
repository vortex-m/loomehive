...
function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <section>
        <h2 className="text-2xl font-semibold mt-4">What do We Collect?</h2>

        <h3 className="font-semibold mt-4">Device Information</h3>
        <p>
          When you visit the Site, we may collect certain information about your
          ...
          Additionally, as you browse the Site, we may collect information about
          ...
          interact with the Site. We refer to this information as “Device
          Information.”
        </p>
        <p>
        ...
        <h3 className="font-semibold mt-4">Order Information</h3>
        <p>
          ...
          billing address, shipping address, payment information, email address,
      ...
      <section>
        ...
        <p>
          We might share your Information with third parties to help us use your
        ...
        <p>
          You understand that your content (not including financial information
          used while purchasing), may be transferred unencrypted and involve (a)
          transmissions over various networks; and (b) changes to conform and
          adapt to technical requirements of connecting networks or devices.
          Financial information is always encrypted during transfer over
          networks.
        </p>
      </section>

      <section>
        <h2 className="text-2xl font-semibold mt-4">Advertising</h2>
        <p>
      ...
      <section>
        <h2 className="text-2xl font-semibold mt-4">Data Retention</h2>
        <p>
          When you place an order through the Site, we will maintain your Order
          Information for our records for an indefinite period.
        </p>
      </section>

      <section>
        <h2 className="text-2xl font-semibold mt-4">Minors</h2>
        <p>
